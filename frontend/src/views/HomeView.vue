...
<template>
  <main class="landing">
    ...
    <div class="center">
      ...
      <p v-if="health.acceptanceMode === 'frozen'" class="scope-note">冻结样本演示 · 仅 600519 贵州茅台 · 样本区间 2025-01-02 ~ 2026-08-31</p>
      <p v-else class="scope-note">V2 投研工作台 · 实时多股票、参数回测与报告历史</p>

      <!-- 大号搜索框：输入即联想，点击结果直达工作台 -->
      <div class="hero-search">
        <SearchBox />
      </div>
      <button v-if="health.acceptanceMode === 'frozen'" type="button" class="frozen-entry" @click="router.push('/stock/600519')">
        进入 600519 冻结演示
      </button>
    </div>
  </main>
